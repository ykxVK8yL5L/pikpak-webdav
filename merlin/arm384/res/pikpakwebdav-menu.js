...
function LoadingALIDRIVEProgress(seconds) {
	action = db_pikpakwebdav["pikpakwebdav_action"];
	//alert(action);
	document.getElementById("LoadingBar").style.visibility = "visible";
	if (action == 0) {
		document.getElementById("loading_block3").innerHTML = "PIKPAK网盘服务关闭中 ..."
		$("#loading_block2").html("<li><font color='#ffcc00'>关闭中</font></li>");
	} else if (action == 1) {
		document.getElementById("loading_block3").innerHTML = "PIKPAK网盘服务启用中 ..."
